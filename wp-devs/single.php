...
<main class="container mx-auto px-4 py-8">
    ...
    <div class="mb-8 rounded-xl overflow-hidden">
        ...
        <?php if (get_post(get_post_thumbnail_id())->post_excerpt): ?>
            <p class="text-sm text-gray-500 mt-2"><?php echo esc_html(get_post(get_post_thumbnail_id())->post_excerpt); ?></p>
        <?php endif; ?>
    </div>
    <?php endif; ?>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-12 gap-8">
        ...
        <aside class="lg:col-span-4">
            ...
            <div class="bg-blue-50 rounded-xl p-6 mb-8">
                <h3 class="headline-font text-xl font-bold text-gray-900 mb-3">Stay Updated</h3>
                <p class="text-gray-600 mb-4">Get the latest technology news delivered to your inbox.</p>
                <form>
                    <input type="email" placeholder="Your email address" class="w-full px-4 py-3 mb-3 rounded-lg border border-gray-300 focus:outline-none focus:ring-2 focus:ring-blue-500">
                    <button type="submit" class="w-full px-6 py-3 bg-blue-600 text-white font-medium rounded-lg hover:bg-blue-700 transition duration-300">Subscribe</button>
                </form>
            </div>
            <!-- Related Articles -->
            <div class="bg-white rounded-xl shadow-md p-6 mb-8">
    ...
    <!-- More From Category -->
    <div class="mb-12">
        <h2 class="headline-font text-2xl font-bold mb-6 pb-2 border-b border-gray-200">More in <?php echo (is_array($category) && isset($category[0]) && is_object($category[0]) && isset($category[0]->name)) ? esc_html($category[0]->name) : 'Category'; ?></h2>
