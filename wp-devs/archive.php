...
<main class="container mx-auto px-4 py-8">
    <!-- Page Header -->
    <div class="mb-8">
        <?php the_archive_title('<h1 class="headline-font text-3xl md:text-4xl font-bold text-gray-900 mb-2">', '</h1>'); ?>
        <?php the_archive_description('<div class="archive-description text-gray-600 mb-4">', '</div>'); ?>
    ...
    <div class="flex justify-center mb-12">
        ...
        if ($pagination) {
            ...
            foreach ($pagination as $page) {
                // Add custom classes to active and normal page links
